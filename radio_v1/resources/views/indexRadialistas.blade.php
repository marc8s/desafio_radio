							...
							<tr>
								...
								<td>
									@if(Request::is("escalaradialista/*"))
										<a href="http://localhost/desafio_radio/radio_v1/public/escalaradialista/create/{{$idprogramacao}}/{{$idprograma}}/{{$radialista->id}} " class="btn btn-default btn-sm">Adicionar a Programação</a>									
									@endif
